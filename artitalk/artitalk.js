...
!function(e, t) {
    ...
    return function(e) {
        ...
        (function(e, n) {
            ...
            !function() {
                ...
                void 0 === t || t.nodeType ? i._ = _ : (void 0 !== n && !n.nodeType && n.exports && (t = n.exports = _),
                t._ = _),
                _.VERSION = "1.9.1";
                ...
                _.invoke = w((function(e, t, n) {
                    var r, i;
                    return _.isFunction(t) ? i = t : _.isArray(t) && (r = t.slice(0, -1),
                    t = t[t.length - 1]),
                    _.map(e, (function(e) {
                        var o = i;
                        if (!o) {
                            if (r && r.length && (e = x(e, r)),
                            null == e)
                                return;
                            o = e[t]
                        }
                ...
                _.max = function(e, t, n) {
                    ...
                    if (null == t || "number" == typeof t && "object" != typeof e[0] && null != e)
                        for (var s = 0, u = (e = O(e) ? e : _.values(e)).length; s < u; s++)
                            null != (r = e[s]) && r > o && (o = r);
                    else
                        t = y(t, n),
                ...
                _.unzip = function(e) {
                    for (var t = e && _.max(e, S).length || 0, n = Array(t), r = 0; r < t; r++)
                        n[r] = _.pluck(e, r);
                    return n
                }
                ,
                ...
                var N = !{
                  ...
                  , U = function(e, t) {
                    var n = L.length
                      ...
                      , o = "constructor";
                    for (A(e, o) && !_.contains(t, o) && t.push(o); n--; )
                        (o = L[n])in e && e[o] !== i[o] && !_.contains(t, o) && t.push(o)
                };
                _.keys = function(e) {
                    if (!_.isObject(e))
                        return [];
                ...
                ,
                _.values = function(e) {
                    for (var t = _.keys(e), n = t.length, r = Array(n), i = 0; i < n; i++)
                        r[i] = e[t[i]];
                    return r
                }
                ,
                ...
                _.pick = w((function(e, t) {
                    ...
                    if (null == e)
                        return n;
                    _.isFunction(r) ? (t.length > 1 && (r = b(r, t[1])),
                    t = _.allKeys(e)) : (r = F,
                    t = z(t, !1, !1),
                    e = Object(e));
                ...
                _.omit = w((function(e, t) {
                    var n, r = t[0];
                    return _.isFunction(r) ? (r = _.negate(r),
                    t.length > 1 && (n = t[1])) : (t = _.map(z(t, !1, !1), String),
                    r = function(e, n) {
                ...
                _.template = function(e, t, n) {
                    ...
                    var r, i = RegExp([(t.escape || K).source, (t.interpolate || K).source, (t.evaluate || K).source].join("|") + "|$", "g"), o = 0, a = "__p+='";
                    e.replace(i, (function(t, n, r, i, s) {
                        return a += e.slice(o, s).replace(J, X),
                        o = s + t.length,
        ...
        e.exports = {
            ajax: function(e) {
                ...
                if (r) {
                    ...
                    u.default)(r).map((function(e) {
                        var t = r[e];
                        if (void 0 !== t) {
                            var n = "object" === (void 0 === t ? "undefined" : (0,
                            s.default)(t)) ? (0,
                            a.default)(t) : t;
                ...
                var b = g++;
                h("request(%d) %s %s %o %o %o", b, t, n, r, i, c);
                var y = f("request")(n, {
                    method: t,
                    headers: c,
                    data: i,
                    ...
                    if (h("response(%d) %d %O %o", b, e.status, e.data || e.text, e.header),
                    !1 === e.ok) {
                        var t = new Error;
                        throw t.response = e,
                        t
                    ...
                    throw e.response && (d.enabled("leancloud:request") || p("request(%d) %s %s %o %o %o", b, t, n, r, i, c),
                    p("response(%d) %d %O %o", b, e.response.status, e.response.data || e.response.text, e.response.header),
            ...
            transformFetchOptions: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
                  ...
                  , r = e.includeACL
                  , i = {};
                return t && (i.keys = m(t).join(",")),
                n && (i.include = m(n).join(",")),
                r && (i.returnACL = r),
                i
            },
    ...
    , function(e, t, n) {
        ...
        var r = function(e) {
          ...
          , h = function(e, t) {
            t ? e["X-LC-Sign"] = d(s.applicationKey) : e["X-LC-Key"] = s.applicationKey
        }
          , p = function() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
              , t = arguments[1]
              ...
              , i = !1;
            return "boolean" == typeof e.useMasterKey ? i = e.useMasterKey : "boolean" == typeof s._config.useMasterKey && (i = s._config.useMasterKey),
            i ? s.masterKey ? t ? n["X-LC-Sign"] = d(s.masterKey, !0) : n["X-LC-Key"] = s.masterKey + ",master" : (console.warn("masterKey is not set, fall back to use appKey"),
            h(n, t)) : h(n, t),
            s.hookKey && (n["X-LC-Hook-Key"] = s.hookKey),
            null !== s._config.production && (n["X-LC-Prod"] = String(s._config.production)),
          ...
          , f = function(e) {
            ...
            return p(c, h).then((function(e) {
                return l({
                    ...
                    s._sharedConfig.keepErrorRawMessage || (t.error += " [" + (e.statusCode || "N/A") + " " + r + " " + g + "]");
                    var n = new Error(t.error);
                    throw delete t.error,
                    i.extend(n, t)
                }
                ))
            }
        ...
        e.exports = {
            _request: function(e, t, n, r, i, o, s) {
                ...
                return r && "get" === r.toLowerCase() && (s = a({}, s, i),
                i = null),
                f({
                    method: r,
                    path: u,
    ...
    , function(e, t, n) {
        var r = n(3)
          ...
          , s = n(14)
          , u = function(e, t, n) {
            var c, l, d, h = e & u.F, p = e & u.G, f = e & u.S, g = e & u.P, m = e & u.B, _ = e & u.W, v = p ? i : i[t] || (i[t] = {}), b = v.prototype, y = p ? r : f ? r[t] : (r[t] || {}).prototype;
            for (c in p && (n = t),
            n)
                (l = !h && y && void 0 !== y[c]) && s(v, c) || (d = l ? y[c] : n[c],
                v[c] = p && "function" != typeof y[c] ? n[c] : m && l ? o(d, r) : _ && y[c] == d ? function(e) {
    ...
    , function(e, t, n) {
        ...
        (function(t) {
            ...
            g._getAVPath = function(e) {
                ...
                "AV/" + g.applicationId + "/" + e
            }
            ,
            g._installationId = null,
            g._getInstallationId = function() {
                if (g._installationId)
                    return a.default.resolve(g._installationId);
                var e = g._getAVPath("installationId");
                return g.localStorage.getItemAsync(e).then((function(t) {
                    return g._installationId = t,
                    g._installationId ? t : (g._installationId = t = u(),
                    g.localStorage.setItemAsync(e, t).then((function() {
                        return t
                    }
                    )))
                }
            ...
            g._getSubscriptionId = function() {
                if (g._subscriptionId)
                    return a.default.resolve(g._subscriptionId);
                var e = g._getAVPath("subscriptionId");
                return g.localStorage.getItemAsync(e).then((function(t) {
                    return g._subscriptionId = t,
                    g._subscriptionId || (t = g._refreshSubscriptionId(e)),
                    t
                }
                ))
            }
            ...
            g._encode = function(e, t, n) {
                ...
                if (s.isRegExp(e))
                    return e.source;
                if (e instanceof g.Relation)
                    return e.toJSON();
                if (e instanceof g.Op)
                    return e.toJSON();
            ...
            g._decode = function(e, t) {
                ...
                if ("ACL" === t)
                    return new g.ACL(e);
                if (e.__op)
                    return g.Op._decode(e);
                var n;
                if ("Pointer" === e.__type) {
                    n = e.className;
                    var r = g.Object._create(n);
                    if ((0,
                    o.default)(e).length > 3) {
                        var i = s.clone(e);
                        delete i.__type,
                        delete i.className,
                        r._finishFetch(i, !0)
                ...
                if ("Object" === e.__type) {
                    ...
                    return u._finishFetch(a, !0),
                    u
                }
                if ("Date" === e.__type)
                    return g._parseDate(e.iso);
            ...
            ,
            g._arrayEach = s.each,
            g._traverse = function(e, t, n) {
                if (e instanceof g.Object) {
                    if (n = n || [],
                    s.indexOf(n, e) >= 0)
                        return;
                    return n.push(e),
                    g._traverse(e.attributes, t, n),
                    t(e)
                }
    ...
    , function(e, t, n) {
        ...
        e.exports = {
            getAdapter: function(e) {
                var t = i[e];
                if (void 0 === t)
                    throw new Error(e + " adapter is not configured");
                return t
            },
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t, n, f, g, m, _) {
            ...
            }, k = t + " Iterator", j = "values" == g, A = !1, x = e.prototype, E = x[d] || x["@@iterator"] || g && x[g], S = E || w(g), O = g ? j ? w("entries") : S : void 0, C = "Array" == t && x.entries || E;
            if (C && (y = l(C.call(new e))) !== Object.prototype && y.next && (c(y, k, !0),
            r || "function" == typeof y[d] || a(y, d, p)),
            j && E && "values" !== E.name && (A = !0,
            S = function() {
                return E.call(this)
            }
            ),
    ...
    , function(e, t, n) {
        var r = n(8)
          ...
          , s = function() {}
          , u = function() {
            var e, t = n(38)("iframe"), r = o.length;
    ...
    , function(e, t, n) {
        var r, i, o, a = n(22), s = n(96), u = n(57), c = n(38), l = n(3), d = l.process, h = l.setImmediate, p = l.clearImmediate, f = l.MessageChannel, g = l.Dispatch, m = 0, _ = {}, v = function() {
            var e = +this;
    ...
    , function(e, t, n) {
        ...
        t.setAsync = function(e, t, n) {
            ...
            return "number" == typeof n && (a.expiredAt = Date.now() + n),
            i.setItemAsync("AV/" + o.applicationId + "/" + e, (0,
            r.default)(a))
        }
    }
    , function(e, t, n) {
    ...
    , function(e, t, n) {
        ...
        function i(e) {
            return (i = "function" == typeof s.default && "symbol" === (0,
            a.default)(o.default) ? function(e) {
                return void 0 === e ? "undefined" : (0,
                a.default)(e)
            }
            : function(e) {
                return e && "function" == typeof s.default && e.constructor === s.default && e !== s.default.prototype ? "symbol" : void 0 === e ? "undefined" : (0,
                a.default)(e)
            }
            )(e)
        }
    ...
    , function(e, t, n) {
        "use strict";
        var r, i, o, a, s = n(21), u = n(3), c = n(22), l = n(44), d = n(10), h = n(13), p = n(29), f = n(94), g = n(95), m = n(61), _ = n(62).set, v = n(97)(), b = n(46), y = n(63), w = n(98), k = n(64), j = u.TypeError, A = u.process, x = A && A.versions, E = x && x.v8 || "", S = u.Promise, O = "process" == l(A), C = function() {}, T = i = b.f, P = !!function() {
            try {
                var e = S.resolve(1)
                    ...
                    for (var r = e._v, i = 1 == e._s, o = 0; n.length > o; )
                        !function(t) {
                            ...
                            try {
                                ...
                                l && (l.exit(),
                                a = !0)),
                                n === t.promise ? c(j("Promise-chain cycle")) : (o = z(n)) ? o.call(n, u, c) : u(n)) : c(r)
                            } catch (e) {
                                l && !a && l.exit(),
                                c(e)
                            }
    ...
    , function(e, t, n) {
        ...
        (t = e.exports = function(e, t, n, d, h) {
            var p, f, g, m, _ = h ? function() {
                return e
            }
            : u(e), v = r(n, d, t ? 2 : 1), b = 0;
            if ("function" != typeof _)
                throw TypeError(e + " is not iterable!");
            if (o(_)) {
                for (p = s(e.length); p > b; b++)
                    if ((m = t ? v(a(f = e[b])[0], f[1]) : v(e[b])) === c || m === l)
                        return m
            } else
                for (g = _.call(e); !(f = g.next()).done; )
                    if ((m = i(g, v, f.value, t)) === c || m === l)
                        return m
        }
        ).BREAK = c,
        t.RETURN = l
    ...
    , function(e, t, n) {
        n(113),
        e.exports = n(1).Object.getPrototypeOf
    }
    , function(e, t, n) {
        var r = n(26)
          , i = n(58);
    ...
    , function(e, t, n) {
        ...
        : function(e) {
          ...
          , $ = function(e, t, n) {
            ...
            t = k(t, !0),
            v(n),
            i(R, t) ? (n.enumerable ? (i(e, N) && e[N][t] && (e[N][t] = !1),
            n = A(n, {
                enumerable: j(0, !1)
            })) : (i(e, N) || P(e, N, j(1, {})),
            e[N][t] = !0),
          ...
          , Z = function(e, t) {
            ...
            e !== F || !i(R, t) || i(D, t)) {
                var n = T(e, t);
                return !n || !i(R, t) || i(e, N) && e[N][t] || (n.enumerable = !0),
                n
            }
        }
          , Y = function(e) {
            for (var t, n = z(w(e)), r = [], o = 0; n.length > o; )
                i(R, t = n[o++]) || t == N || t == u || r.push(t);
            return r
        }
          , ee = function(e) {
            for (var t, n = e === F, r = z(n ? D : w(e)), o = [], a = 0; r.length > a; )
        ...
        n(50).f = X,
        S.f = ee,
        o && !n(21) && s(F, "propertyIsEnumerable", X, !0),
        f.f = function(e) {
            return G(p(e))
        }
        ),
    ...
    , function(e, t, n) {
        ...
        o.init = function(e) {
            ...
            h(t) && !_ && d(o._config.serverURLs))
                throw new TypeError("serverURL option is required for apps from CN region");
            t !== o._config.applicationId ? (o._config.masterKey = i,
            o._config.hookKey = s) : (i && (o._config.masterKey = i),
            s && (o._config.hookKey = s)),
            o._config.applicationId = t,
            o._config.applicationKey = n,
            o.setProduction(b),
            void 0 !== v && (o._config.disableCurrentUser = v);
            var w = f || void 0 !== _;
            if (w || (o._appRouter = new a(o)),
            o._setServerURLs(c({}, r(t), o._config.serverURLs, "string" == typeof _ ? p(_) : _), w),
            y)
                o._config.realtime = y;
        ...
        o._setServerURLs = function(e) {
            ...
            "string" != typeof e ? c(o._config.serverURLs, e) : o._config.serverURLs = p(e),
            t && (o._appRouter ? o._appRouter.disable() : f = !0)
        }
        ,
        ...
        ,
        o.setServerURLs = o.setServerURL,
        o.keepErrorRawMessage = function(e) {
    ...
    , function(e, t, n) {
        ...
        function r(e) {
            ...
            this.AV = e,
            this.lockedUntil = 0,
            o.getAsync("serverURLs").then((function(e) {
                if (!t.disabled) {
                    if (!e)
                        return t.lock(0);
                    var n = e.serverURLs
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            e.GeoPoint = function(t, n) {
                i.isArray(t) ? (e.GeoPoint._validate(t[0], t[1]),
                this.latitude = t[0],
                this.longitude = t[1]) : i.isObject(t) ? (e.GeoPoint._validate(t.latitude, t.longitude),
                this.latitude = t.latitude,
                this.longitude = t.longitude) : i.isNumber(t) && i.isNumber(n) ? (e.GeoPoint._validate(t, n),
                this.latitude = t,
                ...
                this.__defineSetter__("latitude", (function(t) {
                    e.GeoPoint._validate(t, r.longitude),
                    r._latitude = t
                }
                )),
                this.__defineSetter__("longitude", (function(t) {
                    e.GeoPoint._validate(r.latitude, t),
                    r._longitude = t
                }
                )))
            }
            ...
            i.extend(e.GeoPoint.prototype, {
                ...
                radiansTo: function(e) {
                    ...
                    return c = Math.min(1, c),
                    2 * Math.asin(Math.sqrt(c))
                },
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.ACL.prototype._setAccess = function(t, n, i) {
                ...
                i ? this.permissionsById[n][t] = !0 : (delete o[t],
                    ...
                    if (t) {
                        ...
                        if (t instanceof e.Op.Relation) {
                            if (t._targetClassName && t._targetClassName !== this._targetClassName)
                                throw new Error("Related object must be of class " + t._targetClassName + ", but " + this._targetClassName + " was passed in.");
                            ...
                            if (this._targetClassName)
                                if (t.targetClassName) {
                                    if (t.targetClassName !== this._targetClassName)
                                        throw new Error("Related object must be a " + t.targetClassName + ", but a " + this._targetClassName + " was passed in.")
                                } else
        ...
        e.exports = function(e) {
            ...
            r.extend(e.Relation.prototype, {
                ...
                query: function() {
                    ...
                    (n = new e.Query(t))._defaultParams.redirectClassNameForKey = this.key),
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.File = function(t, r, o) {
                ...
                i.isArray(r) && (this.attributes.metaData.size = r.length,
                r = {
                    base64: g(r)
                }),
                this._extName = "",
            ...
            i.extend(e.File.prototype, {
                ...
                setACL: function(t) {
                    return t instanceof e.ACL ? (this._acl = t,
                    this) : new u(u.OTHER_CAUSE,"ACL must be a AV.ACL.")
                },
                name: function() {
                ...
                setUploadHeader: function(e, t) {
                    return this._uploadHeaders[e] = t,
                    this
                },
                metaData: function(e, t) {
                    return e && t ? (this.attributes.metaData[e] = t,
                    this) : e && !t ? this.attributes.metaData[e] : this.attributes.metaData
                },
                ...
                _fileToken: function(e, r) {
                    ...
                    c("fileTokens", null, null, "POST", s, r)
                },
                save: function() {
                    var e = this
                    ...
                    if (!this._previousSave)
                        if (this._data) {
                            ...
                            this._previousSave = this._fileToken(n, t).then((function(u) {
                                return u.mime_type && (n = u.mime_type,
                                e.set("mime_type", n)),
                                e._token = u.token,
                                r.default.resolve().then((function() {
                                    var t = e._data;
                                    if (t && t.base64)
                                        return f(t.base64, n);
                                    if (t && t.blob)
                                        return !t.blob.type && n && (t.blob.type = n),
                            ...
                            this._previousSave = c("files", this.attributes.name, null, "post", u, t).then((function(t) {
                                return e.attributes.name = t.name,
                ...
                fetch: function(e, t) {
                    return c("files", null, this.id, "GET", h(e), t).then(this._finishFetch.bind(this))
                },
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t, n) {
            ...
            return i("url: %s, file: %o, options: %o", a, s, u),
            r("upload")(a, s, u).then((function(e) {
                if (i(e.status, e.data),
                !1 === e.ok) {
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t, n) {
            ...
            return o("url: %s, file: %o, options: %o", u, c, l),
            i("upload")(u, c, l).then((function(e) {
                if (o(e.status, e.data),
                !1 === e.ok) {
                    var t = e.status;
                    e.data && (t = e.data.error ? e.data.error : (0,
                    r.default)(e.data));
                    var i = new Error(t);
                    throw i.response = e,
                    i
        ...
        !function() {
            var t = n(138)
              ...
              , a = function(e, n) {
                ...
                for (var s = t.bytesToWords(e), u = 8 * e.length, c = 1732584193, l = -271733879, d = -1732584194, h = 271733878, p = 0; p < s.length; p++)
                ...
                for (p = 0; p < s.length; p += 16) {
                    ...
                    c = g(c, l = f(l, d, h, c, s[p + 15], 22, 1236535329), d, h, s[p + 1], 5, -165796510),
                    ...
                    c = m(c, l = g(l, d, h, c, s[p + 12], 20, -1926607734), d, h, s[p + 5], 4, -378558),
                    ...
                    c = _(c, l = m(l, d, h, c, s[p + 2], 23, -995338651), d, h, s[p + 0], 6, -198630844),
 ...
 */
    ...
    , function(e, t, n) {
        ...
        var o = r(n(142))
          ...
          , d = n(6)._request
          , h = n(5)
          , p = h.isNullOrUndefined
          , f = h.ensureArray
          , g = h.transformFetchOptions
          , m = h.setValue
          , _ = h.findValue
          , v = h.isPlainObject
          , b = h.continueWhile
        ...
        e.exports = function(e) {
            ...
            c.extend(e.Object.prototype, e.Events, {
                ...
                _toFullJSON: function(t) {
                    ...
                    c.has(this, "id") && (i.objectId = this.id),
                    c(["createdAt", "updatedAt"]).each((function(e) {
                        if (c.has(n, e)) {
                            var t = n[e];
                    ...
                    r && (i.__type = "Object",
                    c.isArray(t) && t.length && (i.__type = "Pointer"),
                ...
                escape: function(e) {
                    ...
                    return n = p(r) ? "" : c.escape(r.toString()),
                ...
                _mergeMagicFields: function(t) {
                    ...
                    return e._arrayEach(["objectId", "createdAt", "updatedAt"], (function(r) {
                        t[r] && ("objectId" === r ? n.id = t[r] : "createdAt" !== r && "updatedAt" !== r || c.isDate(t[r]) ? n[r] = t[r] : n[r] = e._parseDate(t[r]),
                        delete t[r])
                    }
                    )),
                    t
                    ...
                    e._arrayEach(this._opSetQueue, (function(r) {
                        ...
                        if (i) {
                            ...
                            s.default)(o, 4)
                              ...
                              , l = a[2]
                              , d = a[3];
                            m(n.attributes, t, i._estimate(u, n, t)),
                            c && c[l] === e.Op._UNSET && delete c[l],
                ...
                _rebuildAllEstimatedData: function() {
                    ...
                    this.attributes = c.clone(this._serverData),
                ...
                set: function(t, n, r) {
                    ...
                    r.unset && e._objectEach(i, (function(t, n) {
                        i[n] = new e.Op.Unset
                    }
                    ));
                    var o = c.clone(i)
                    ...
                    e._objectEach(o, (function(t, n) {
                        t instanceof e.Op && (o[n] = t._estimate(a.attributes[n], a, n),
                    ...
                    return e._arrayEach(c.keys(i), (function(t) {
                        ...
                        var o = !0;
                        n instanceof e.Op.Set && c.isEqual(a.attributes[t], n.value) && (o = !1),
                        o && (delete s[t],
                        ...
                        o ? (a.changed[t] = a.attributes[t],
                        r.silent || (a._pending[t] = !0)) : (delete a.changed[t],
                        delete a._pending[t])
                    }
                    )),
                ...
                increment: function(t, n) {
                    return (c.isUndefined(n) || c.isNull(n)) && (n = 1),
                ...
                fetch: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
                      , t = arguments[1]
                      , n = this;
                    return d("classes", this.className, this.id, "GET", g(e), t).then((function(t) {
                        var r = n.parse(t);
                        return n._cleanupUnsetKeys(r, e.keys ? f(e.keys).join(",").split(",") : void 0),
                        n._finishFetch(r, !0),
                        n
                    }
                    ))
                ...
                save: function(t, n, r) {
                    var i, o, a;
                    c.isObject(t) || p(t) ? (i = t,
                    a = n) : ((i = {})[t] = n,
                    a = r),
                    (a = c.clone(a) || {}).wait && (o = c.clone(this.attributes));
                    var s = c.clone(a) || {};
                    s.wait && (s.silent = !0),
                    i && this.set(i, s);
                    var l = this
                      , h = []
                      , f = [];
                    return e.Object._findUnsavedChildren(l, h, f),
                    h.length + f.length > 1 ? e.Object._deepSaveAsync(this, l, a) : (this._startSave(),
                    this._saving = (this._saving || 0) + 1,
                    this._allPreviousSaves = this._allPreviousSaves || u.default.resolve(),
                    this._allPreviousSaves = this._allPreviousSaves.catch((function(e) {}
                    )).then((function() {
                        var e, t = l.id ? "PUT" : "POST", n = l._getSaveJSON(), r = {};
                        if (((l._fetchWhenSave || a.fetchWhenSave) && (r.new = "true"),
                        a._failOnNotExist && (r.failOnNotExist = "true"),
                        a.query) && ("function" == typeof a.query._getParams && (e = a.query._getParams()) && (r.where = e.where),
                        !r.where))
                            throw new Error("options.query is not an AV.Query");
                        c.extend(n, l._flags);
                        var u = "classes"
                          , h = l.className;
                        "_User" !== l.className || l.id || (u = "users",
                        h = null);
                        var p = (a._makeRequest || d)(u, h, l.id, t, n, a, r);
                        return p.then((function(e) {
                            var t = l.parse(e);
                            return a.wait && (t = c.extend(i || {}, t)),
                            l._finishSave(t),
                            a.wait && l.set(o, s),
                            l
                        }
                ...
                destroy: function(e) {
                    ...
                    return this.id ? (e.wait || n(),
                    d("classes", this.className, this.id, "DELETE", this._flags, e).then((function() {
                        return e.wait && n(),
                        t
                    }
                    ))) : n()
                ...
                change: function(t) {
                    ...
                    }; !c.isEmpty(this._pending); )
                        this._pending = {},
                        this.trigger("change", this, t),
                        e._objectEach(this.changed, o),
                        r._previousAttributes = c.clone(this.attributes);
                ...
                validate: function(t) {
                    if (c.has(t, "ACL") && !(t.ACL instanceof e.ACL))
                        throw new l(l.OTHER_CAUSE,"ACL must be a AV.ACL.")
                },
                _validate: function(e, t) {
                    !t.silent && this.validate && (e = c.extend({}, this.attributes, e),
                    this.validate(e))
                },
                getACL: function() {
                    return this.get("ACL")
                ...
                ignoreHook: function(t) {
                    if (!c.contains(["beforeSave", "afterSave", "beforeUpdate", "afterUpdate", "beforeDelete", "afterDelete"], t))
            ...
            e.Object.destroyAll = function(e) {
                ...
                return d("batch", null, null, "POST", r, t).then((function(e) {
                    var t = c.find(e, (function(e) {
                        return !e.success
                    }
                    ));
                    if (t)
                        throw new l(t.error.code,t.error.error)
                }
                ))
            }
            ,
            e.Object._getSubclass = function(t) {
                ...
                return n || (n = e.Object.extend(t),
                e.Object._classMap[t] = n),
                n
            }
            ,
            ...
            e.Object.extend = function(t, n, r) {
                ...
                return i.extend = function(n) {
                    if (c.isString(n) || n && c.has(n, "className"))
            ...
            e.Object._deepSaveAsync = function(t, n, r) {
                ...
                return a.then((function() {
                    return b((function() {
                        ...
                        h = n,
                        0 === t.length)
                            return u.default.reject(new l(l.OTHER_CAUSE,"Tried to save a batch with a cycle."));
                        var i = u.default.resolve(c.map(t, (function(e) {
                            ...
                            return d("batch", null, null, "POST", {
                                ...
                                var n = c.map(t, (function(t, n) {
                                    return e[n].success ? (t._finishSave(t.parse(e[n].success)),
                                    t) : (t._cancelSave(),
                                    new l(e[n].error.code,e[n].error.error))
                                }
                                ));
                                return j(n)
                            }
        ...
        e.exports = function(e) {
            e.Role = e.Object.extend("_Role", {
                constructor: function(t, n) {
                    if (r.isString(t) ? (e.Object.prototype.constructor.call(this, null, null),
                    this.setName(t)) : e.Object.prototype.constructor.call(this, t, n),
                    n) {
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            e.User = e.Object.extend("_User", {
                _isCurrentUser: !1,
                _mergeMagicFields: function(t) {
                    return t.sessionToken && (this._sessionToken = t.sessionToken,
                ...
                _synchronizeAuthData: function(t) {
                    if (this.isCurrent()) {
                        var n;
                        s.isString(t) ? (n = t,
                        t = e.User._authProviders[n]) : n = t.getAuthType();
                ...
                _handleSaveResult: function(t) {
                    ...
                    this._refreshCache(),
                    !t && !this.isCurrent() || e._config.disableCurrentUser ? a.default.resolve() : a.default.resolve(e.User._saveCurrentUser(this))
                },
                _linkWith: function(t, n) {
                    var r, i = this, a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, u = a.failOnNotExist, c = void 0 !== u && u;
                    return s.isString(t) ? (r = t,
                    t = e.User._authProviders[t]) : r = t.getAuthType(),
                    n ? this.save({
                        authData: (0,
                        o.default)({}, r, n)
                    }, {
                ...
                _isLinked: function(e) {
                    var t;
                    return t = s.isString(e) ? e : e.getAuthType(),
                    !!(this.get("authData") || {})[t]
                },
                ...
                _logOutWith: function(t) {
                    this.isCurrent() && (s.isString(t) && (t = e.User._authProviders[t]),
                    t && t.deauthenticate && t.deauthenticate())
                },
                signUp: function(e, t) {
                    var n = e && e.username || this.get("username");
                    if (!n || "" === n)
                        throw new c(c.OTHER_CAUSE,"Cannot sign up user with an empty name.");
                    var r = e && e.password || this.get("password");
                    if (!r || "" === r)
                        throw new c(c.OTHER_CAUSE,"Cannot sign up user with an empty password.");
                    return this.save(e, t).then((function(e) {
                        return e.isAnonymous() && (e.unset("authData.anonymous"),
                        e._opSetQueue = [{}]),
                ...
                signUpOrlogInWithMobilePhone: function(e) {
                    ...
                    if (!n || "" === n)
                        throw new c(c.OTHER_CAUSE,"Cannot sign up or login user by mobilePhoneNumber with an empty mobilePhoneNumber.");
                    var r = e && e.smsCode || this.get("smsCode");
                    if (!r || "" === r)
                        throw new c(c.OTHER_CAUSE,"Cannot sign up or login user by mobilePhoneNumber  with an empty smsCode.");
                ...
                logIn: function() {
                    var e = this;
                    return d("login", null, null, "POST", this.toJSON()).then((function(t) {
                        var n = e.parse(t);
                ...
                save: function(t, n, r) {
                    var i, o;
                    return s.isObject(t) || s.isNull(t) || s.isUndefined(t) ? (i = t,
                    o = n) : ((i = {})[t] = n,
                    o = r),
                    o = o || {},
                ...
                refreshSessionToken: function(e) {
                    var t = this;
                    return d("users/" + this.id + "/refreshSessionToken", null, null, "PUT", null, e).then((function(e) {
                ...
                logOut: function() {
                    ...
                    a.default.resolve(null)) : (null !== e.User._currentUser && (e.User._currentUser._logOutWithAll(),
                ...
                requestPasswordReset: function(e) {
                    return d("requestPasswordReset", null, null, "POST", {
                        email: e
                    })
                },
                requestEmailVerify: function(e) {
                    return d("requestEmailVerify", null, null, "POST", {
                        email: e
                    })
                },
                ...
                currentAsync: function() {
                    ...
                    a.default.resolve(null)) : e.User._currentUser || e.User._currentUserMatchesDisk ? a.default.resolve(e.User._currentUser) : e.localStorage.getItemAsync(e._getAVPath(e.User._CURRENT_USER_KEY)).then((function(t) {
                        if (!t)
                            return null;
                        e.User._currentUserMatchesDisk = !0,
                ...
                current: function() {
                    ...
                    e.User._currentUser._isCurrentUser = !0;
                    var r = JSON.parse(n);
                    return e.User._currentUser.id = r._id,
                    delete r._id,
                ...
                _saveCurrentUser: function(t) {
                    return (e.User._currentUser !== t ? e.User.logOut() : a.default.resolve()).then((function() {
                        ...
                        e.localStorage.setItemAsync(e._getAVPath(e.User._CURRENT_USER_KEY), (0,
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.Query.doCloudQuery = function(t, n, r) {
                ...
                return a.isArray(n) ? i.pvalues = n : r = n,
            ...
            a.extend(e.Query.prototype, {
                ...
                get: function(e, t) {
                    ...
                    if ("" === e)
                        return o.default.reject(new u(u.OBJECT_NOT_FOUND,"Object not found."));
                    ...
                    l("classes", this.className, e, "GET", f(i), t).then((function(e) {
                        if (a.isEmpty(e))
                ...
                _getParams: function() {
                    ...
                    return this._include.length > 0 && (e.include = this._include.join(",")),
                ...
                scan: function() {
                    var e = this
                      ...
                      , u = this._getParams();
                    s("scan %O", u),
                    u.order && (console.warn("The order of the query is ignored for Query#scan. Checkout the orderedBy option of Query#scan."),
                    delete u.order),
                    u.skip && (console.warn("The skip option of the query is ignored for Query#scan."),
                    delete u.skip),
                    u.limit && (console.warn("The limit option of the query is ignored for Query#scan."),
                    delete u.limit),
                    n && (u.scan_key = n),
                    r && (u.limit = r);
                    ...
                    return {
                        next: function() {
                            return (c = c.then((function(t) {
                                return h ? [] : t.length > 1 ? t : d || 0 === t.length ? l("scan/classes", e.className, null, "GET", d ? a.extend({}, u, {
                                    cursor: d
                                }) : u, i).then((function(t) {
                                    return d = t.cursor,
                                    e._parseResponse(t)
                ...
                skip: function(e) {
                    return m(e, "undefined is not a valid skip value"),
                    this._skip = e,
                    this
                },
                limit: function(e) {
                    return m(e, "undefined is not a valid limit value"),
                    this._limit = e,
                    this
                },
                ...
                _addCondition: function(t, n, r) {
                    return m(t, "undefined is not a valid condition key"),
                ...
                sizeEqualTo: function(e, t) {
                    return this._addCondition(e, "$size", t),
                    this
                },
        ...
        e.exports = function(e) {
            ...
            e.LiveQuery = a(o, {
                ...
                unsubscribe: function() {
                    var e = this._client;
                    return e.off("message", this._onMessage),
                ...
                pause: function() {
                    return t(),
                    e._config.realtime.pause()
                },
                resume: function() {
                    return t(),
                    e._config.realtime.resume()
                }
            })
        }
    }
    , function(e, t, n) {
        ...
        o.prototype.removeListener = function(e, t, n, i) {
            ...
            if (a.fn)
                a.fn !== t || i && !a.once || n && a.context !== n || (0 == --this._eventsCount ? this._events = new r : delete this._events[o]);
            else {
        ...
        e.exports = function(e) {
            ...
            i.extend(e.Cloud, {
                ...
                verifySmsCode: function(e, t) {
                    ...
                    var n = {};
                    return i.isString(t) && (n.mobilePhoneNumber = t),
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.Push.send = function(e, t) {
                if (e.where && (e.where = e.where._getParams().where),
                e.where && e.cql)
                    throw new Error("Both where and cql can't be set");
                if (e.push_time && (e.push_time = e.push_time.toJSON()),
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.Status = function(e, t) {
                ...
                o.default)(e)) ? this.data = e : (e && (this.data.image = e),
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            i.extend(e.SearchSortBuilder.prototype, {
                ...
                build: function() {
                    return (0,
                    r.default)(e._encode(this._sortFields))
                }
            }),
            e.SearchQuery = e.Query._extend({
                ...
                highlights: function(e) {
                    var t;
                    return t = e && i.isString(e) ? arguments : e,
                    this._highlights = t,
                    this
                },
                sortBy: function(e) {
    ...
    , function(e, t, n) {
        ...
        var r = function(e) {
          ...
          , a = n(18)
          , s = function(e) {
            return "string" == typeof e ? e : "function" == typeof e.getPayload ? (0,
            r.default)(e.getPayload()) : (0,
            r.default)(e)
        };
        e.exports = a.Object.extend("_Conversation", {
            ...
            broadcast: function(e, t) {
                ...
                if (void 0 !== n.pushData && (a.push = n.pushData),
                void 0 !== n.validTill) {
                    var u = n.validTill;
                    i.isDate(u) && (u = u.getTime()),
                    n.valid_till = u
                }
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            return e.setAdapters(r),
            e._sharedConfig.userAgent = i(o),
            e
        }
    }
    , function(e, t, n) {
    ...
    , function(e, t, n) {
        ...
        function i(e) {
            return (i = "function" == typeof m.default && "symbol" === (0,
            g.default)(f.default) ? function(e) {
                return void 0 === e ? "undefined" : (0,
                g.default)(e)
            }
            : function(e) {
                return e && "function" == typeof m.default && e.constructor === m.default && e !== m.default.prototype ? "symbol" : void 0 === e ? "undefined" : (0,
                g.default)(e)
            }
            )(e)
        }
        ...
        function s(e, t, n) {
            if (void 0 !== n) {
                if (null === n)
                    return void e.push(encodeURI(t));
                if (Array.isArray(n))
                    ...
                    for (var r in n)
                        Object.prototype.hasOwnProperty.call(n, r) && s(e, "".concat(t, "[").concat(r, "]"), n[r]);
                else
        ...
        function l(e) {
            ...
            this.headers = function(e) {
                for (var t, n, r, i, o = e.split(/\r?\n/), a = {}, s = 0, u = o.length; s < u; ++s)
                    -1 !== (t = (n = o[s]).indexOf(":")) && (r = n.slice(0, t).toLowerCase(),
                    i = A(n.slice(t + 1)),
                    a[r] = i);
                return a
        ...
        var p, f = r(n(34)), g = r(n(27)), m = r(n(35));
        ...
        l.prototype._parseBody = function(e) {
            ...
            return this.req._parser ? this.req._parser(this, e) : (!t && c(this.type) && (t = j.parse["application/json"]),
        ...
        d.prototype.type = function(e) {
            return this.set("Content-Type", j.types[e] || e),
            this
        }
        ,
        d.prototype.accept = function(e) {
            return this.set("Accept", j.types[e] || e),
            this
        }
        ,
        d.prototype.auth = function(e, t, n) {
            1 === arguments.length && (t = ""),
            "object" === i(t) && null !== t && (n = t,
            t = ""),
            n || (n = {
        ...
        d.prototype._end = function() {
            ...
            !this._formData && "GET" !== this.method && "HEAD" !== this.method && "string" != typeof n && !this._isHost(n)) {
                ...
                !o && c(i) && (o = j.serialize["application/json"]),
                o && (n = o(n))
            }
            for (var a in this.header)
                null !== this.header[a] && Object.prototype.hasOwnProperty.call(this.header, a) && t.setRequestHeader(a, this.header[a]);
    ...
    , function(e, t) {
        function n(e, t, n) {
            var i;
            for (r(e, "", [], void 0),
            i = 0 === c.length ? JSON.stringify(e, t, n) : JSON.stringify(e, s(t), n); 0 !== u.length; ) {
                var o = u.pop();
            ...
            if ("object" == typeof e && null !== e) {
                for (o = 0; o < n.length; o++)
                    if (n[o] === e) {
                        ...
                        return void (void 0 !== a.get ? a.configurable ? (Object.defineProperty(i, t, {
                            value: "[Circular]"
                        }),
                        u.push([i, t, e, a])) : c.push([e, t]) : (i[t] = "[Circular]",
                        u.push([i, t, e])))
                    }
                if (n.push(e),
                Array.isArray(e))
        ...
        function o(e, t, n) {
            var r, i = a(e, "", [], void 0) || e;
            for (r = 0 === c.length ? JSON.stringify(i, t, n) : JSON.stringify(i, s(t), n); 0 !== u.length; ) {
                var o = u.pop();
                4 === o.length ? Object.defineProperty(o[0], o[1], o[3]) : o[0][o[1]] = o[2]
            }
            return r
            ...
            if ("object" == typeof e && null !== e) {
                for (o = 0; o < n.length; o++)
                    if (n[o] === e) {
                        ...
                        u.push([r, t, e, s])) : c.push([e, t]) : (r[t] = "[Circular]",
                        u.push([r, t, e])))
                    }
    ...
    , function(e, t, n) {
        ...
        function i(e) {
            return (i = "function" == typeof c.default && "symbol" === (0,
            u.default)(s.default) ? function(e) {
                return void 0 === e ? "undefined" : (0,
                u.default)(e)
            }
            : function(e) {
                return e && "function" == typeof c.default && e.constructor === c.default && e !== c.default.prototype ? "symbol" : void 0 === e ? "undefined" : (0,
                u.default)(e)
            }
            )(e)
        }
        ...
        o.prototype.field = function(e, t) {
            ...
            return "boolean" == typeof t && (t = String(t)),
        ...
        o.prototype.send = function(e) {
            ...
            if (t && l(this._data))
                ...
                n = this._header["content-type"],
                this._data = "application/x-www-form-urlencoded" === n ? this._data ? "".concat(this._data, "&").concat(e) : e : (this._data || "") + e) : this._data = e;
        ...
        o.prototype._finalizeQueryString = function() {
            ...
            if (e && (this.url += (this.url.includes("?") ? "&" : "?") + e),
    ...
    , function(e, t, n) {
        ...
        function r(e) {
            if (e)
                return function(e) {
                    for (var t in r.prototype)
                        Object.prototype.hasOwnProperty.call(r.prototype, t) && (e[t] = r.prototype[t]);
                    return e
                }(e)
        }
        var i = n(173);
    ...
    , function(e, t, n) {
        ...
        function i(e) {
            return function(e) {
                ...
                if ((0,
                s.default)(Object(e)) || "[object Arguments]" === Object.prototype.toString.call(e))
                    return (0,
                    a.default)(e)
            }(e) || function() {
    ...
    , function(e, t, n) {
        ...
        i(i.S + i.F * !n(65)((function(e) {
            ...
            from: function(e) {
                var t, n, i, d, h = o(e), p = "function" == typeof this ? this : Array, f = arguments.length, g = f > 1 ? arguments[1] : void 0, m = void 0 !== g, _ = 0, v = l(h);
                if (m && (g = r(g, f > 2 ? arguments[2] : void 0, 2)),
                null == v || p == Array && s(v))
                    for (n = new p(t = u(h.length)); t > _; _++)
                        c(n, _, m ? g(h[_], _) : h[_]);
                else
                    for (d = v.call(h),
                    n = new p; !(i = d.next()).done; _++)
 ...
 */
function(e) {
    var t, n = {}, r = navigator.userAgent.toLowerCase(), i = (navigator.platform,
    r.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || []);
    /trident/i.test(i[1]) && (t = /\brv[ :]+(\d+)/g.exec(r) || [],
    i[1] = "IE",
    i[2] = t[1] || ""),
    "Chrome" === i[1] && null != (t = r.match(/\b(OPR|Edge)\/(\d+)/)) && (i[1] = "Opera",
    i[2] = t[1] || ""),
    ...
    switch (/Windows/.test(o) && (a = /Windows (.*)/.exec(o)[1],
    o = "Windows"),
    o) {
    case "Mac OS X":
...
function() {
    ...
    function t(e, t) {
        ...
        for (var o = 0; o < e.length; ++o) {
            ...
            if (!r.helper.isString(s.type))
                return i.valid = !1,
                i.error = a + 'property "type" must be a string, but ' + typeof s.type + " given",
                i;
            var u = s.type = s.type.toLowerCase();
            if ("language" === u && (u = s.type = "lang"),
            "html" === u && (u = s.type = "output"),
            "lang" !== u && "output" !== u && "listener" !== u)
                return i.valid = !1,
                i.error = a + "type " + u + ' is not recognized. Valid values: "lang/language", "output/html" or "listener"',
                i;
            if ("listener" === u) {
                if (r.helper.isUndefined(s.listeners))
                    return i.valid = !1,
                    i.error = a + '. Extensions of type "listener" must have a property called "listeners"',
                    i
            } else if (r.helper.isUndefined(s.filter) && r.helper.isUndefined(s.regex))
                return i.valid = !1,
                i.error = a + u + ' extensions must define either a "regex" property or a "filter" method',
                i;
            if (s.listeners) {
                if ("object" != typeof s.listeners)
                    return i.valid = !1,
                    i.error = a + '"listeners" property must be an object but ' + typeof s.listeners + " given",
                    i;
                for (var c in s.listeners)
                    if (s.listeners.hasOwnProperty(c) && "function" != typeof s.listeners[c])
                        return i.valid = !1,
                        i.error = a + '"listeners" property must be an hash of [event name]: [callback]. listeners.' + c + " must be a function but " + typeof s.listeners[c] + " given",
                        i
            }
            if (s.filter) {
                if ("function" != typeof s.filter)
                    return i.valid = !1,
                    i.error = a + '"filter" must be a function, but ' + typeof s.filter + " given",
                    i
            } else if (s.regex) {
                if (r.helper.isString(s.regex) && (s.regex = new RegExp(s.regex,"g")),
                !(s.regex instanceof RegExp))
                    return i.valid = !1,
                    i.error = a + '"regex" property must either be a string or a RegExp object, but ' + typeof s.regex + " given",
                    i;
                if (r.helper.isUndefined(s.replace))
                    return i.valid = !1,
                    i.error = a + '"regex" extensions must implement a replace string or function',
                    i
            }
        }
        return i
    ...
    r.extension = function(e, n) {
        ...
        if (e = r.helper.stdExtName(e),
        r.helper.isUndefined(n)) {
    ...
    r.validateExtension = function(e) {
        "use strict";
        var n = t(e, null);
        return !!n.valid || (console.warn(n.error),
        !1)
    }
    ,
    ...
    var c = function(e, t, n, r) {
        "use strict";
        var i, o, a, s, u, c = r || "", l = c.indexOf("g") > -1, d = new RegExp(t + "|" + n,"g" + c.replace(/g/g, "")), h = new RegExp(t,c.replace(/g/g, "")), p = [];
        do {
            for (i = 0; a = d.exec(e); )
                if (h.test(a[0]))
                    i++ || (s = (o = d.lastIndex) - a[0].length);
                else if (i && !--i) {
        ...
        } while (i && (d.lastIndex = o));return p
    };
    r.helper.matchRecursiveRegExp = function(e, t, n, r) {
        "use strict";
        for (var i = c(e, t, n, r), o = [], a = 0; a < i.length; ++a)
            o.push([e.slice(i[a].wholeMatch.start, i[a].wholeMatch.end), e.slice(i[a].match.start, i[a].match.end), e.slice(i[a].left.start, i[a].left.end), e.slice(i[a].right.start, i[a].right.end)]);
        return o
    }
    ,
    r.helper.replaceRecursiveRegExp = function(e, t, n, i, o) {
        ...
        if (l > 0) {
            ...
            for (var h = 0; h < l; ++h)
                d.push(t(e.slice(s[h].wholeMatch.start, s[h].wholeMatch.end), e.slice(s[h].match.start, s[h].match.end), e.slice(s[h].left.start, s[h].left.end), e.slice(s[h].right.start, s[h].right.end))),
                h < l - 1 && d.push(e.slice(s[h].wholeMatch.end, s[h + 1].wholeMatch.start));
            s[l - 1].wholeMatch.end < e.length && d.push(e.slice(s[l - 1].wholeMatch.end)),
            u = d.join("")
        }
        return u
    }
    ...
    r.Converter = function(e) {
        ...
        this.makeHtml = function(e) {
            ...
            e = "\n\n" + e + "\n\n",
            e = (e = r.subParser("detab")(e, c, t)).replace(/^[ \t]+$/gm, ""),
            r.helper.forEach(l, (function(n) {
                e = r.subParser("runExtension")(n, e, c, t)
            }
            )),
            e = r.subParser("metadata")(e, c, t),
            e = r.subParser("hashPreCodeTags")(e, c, t),
            e = r.subParser("githubCodeBlocks")(e, c, t),
            e = r.subParser("hashHTMLBlocks")(e, c, t),
            e = r.subParser("hashCodeTags")(e, c, t),
            e = r.subParser("stripLinkDefinitions")(e, c, t),
            e = r.subParser("blockGamut")(e, c, t),
            e = r.subParser("unhashHTMLSpans")(e, c, t),
            e = (e = (e = r.subParser("unescapeSpecialChars")(e, c, t)).replace(/¨D/g, "$$")).replace(/¨T/g, "¨"),
            e = r.subParser("completeHTMLDocument")(e, c, t),
            r.helper.forEach(d, (function(n) {
                e = r.subParser("runExtension")(n, e, c, t)
            }
            )),
            f = t.metadata,
        ...
        this.makeMarkdown = this.makeMd = function(e, t) {
                ...
                preList: function(e) {
                    for (var t = e.querySelectorAll("pre"), n = [], i = 0; i < t.length; ++i)
                        if (1 === t[i].childElementCount && "code" === t[i].firstChild.tagName.toLowerCase()) {
                            ...
                            o = r.helper.unescapeHTMLEntities(o),
                            n.push(o),
                            t[i].outerHTML = '<precode language="' + a + '" precodenum="' + i.toString() + '"></precode>'
                        } else
            ...
            for (var o = n.childNodes, a = "", s = 0; s < o.length; s++)
                a += r.subParser("makeMarkdown.node")(o[s], i);
            return a
        }
        ,
        ...
        this.removeExtension = function(e) {
            r.helper.isArray(e) || (e = [e]);
            for (var t = 0; t < e.length; ++t) {
                for (var n = e[t], i = 0; i < l.length; ++i)
                    l[i] === n && l[i].splice(i, 1);
                for (; 0 < d.length; ++i)
                    d[0] === n && d[0].splice(i, 1)
            }
        }
        ,
    ...
    r.subParser("anchors", (function(e, t, n) {
        ...
        var i = function(e, i, o, a, s, u, c) {
            ...
            e.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1)
                ...
                a = "#" + o,
                r.helper.isUndefined(n.gUrls[o]))
                    return e;
                a = n.gUrls[o],
                r.helper.isUndefined(n.gTitles[o]) || (c = n.gTitles[o])
            }
            var l = '<a href="' + (a = a.replace(r.helper.regexes.asteriskDashAndColon, r.helper.escapeCharactersCallback)) + '"';
            return "" !== c && null !== c && (l += ' title="' + (c = (c = c.replace(/"/g, "&quot;")).replace(r.helper.regexes.asteriskDashAndColon, r.helper.escapeCharactersCallback)) + '"'),
            t.openLinksInNewWindow && !/^#/.test(a) && (l += ' rel="noopener noreferrer" target="¨E95Eblank"'),
            l + ">" + i + "</a>"
        };
        return e = (e = (e = (e = (e = n.converter._dispatch("anchors.before", e, t, n)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)] ?(?:\n *)?\[(.*?)]()()()()/g, i)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<([^>]*)>(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, i)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<?([\S]+?(?:\([\S]*?\)[\S]*?)?)>?(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, i)).replace(/\[([^\[\]]+)]()()()()()/g, i),
        t.ghMentions && (e = e.replace(/(^|\s)(\\)?(@([a-z\d]+(?:[a-z\d.-]+?[a-z\d]+)*))/gim, (function(e, n, i, o, a) {
            if ("\\" === i)
                return n + o;
            ...
            var s = t.ghMentionsLink.replace(/\{u}/g, a)
              , u = "";
            return t.openLinksInNewWindow && (u = ' rel="noopener noreferrer" target="¨E95Eblank"'),
            n + '<a href="' + s + '"' + u + ">" + o + "</a>"
        }
        ))),
    ...
    var l = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+?\.[^'">\s]+?)()(\1)?(?=\s|$)(?!["<>])/gi
      ...
      , m = function(e, t) {
        ...
        return function(n, i, o) {
            var a = "mailto:";
            return i = i || "",
            o = r.subParser("unescapeSpecialChars")(o, e, t),
            e.encodeEmails ? (a = r.helper.encodeEmailAddress(a + o),
            o = r.helper.encodeEmailAddress(o)) : a += o,
            i + '<a href="' + a + '">' + o + "</a>"
        }
    };
    r.subParser("autoLinks", (function(e, t, n) {
        "use strict";
        return e = (e = (e = n.converter._dispatch("autoLinks.before", e, t, n)).replace(h, g(t))).replace(f, m(t, n)),
    ...
    r.subParser("simplifiedAutoLinks", (function(e, t, n) {
        ...
        e = (e = t.excludeTrailingPunctuationFromURLs ? e.replace(d, g(t)) : e.replace(l, g(t))).replace(p, m(t, n)),
    ...
    r.subParser("codeBlocks", (function(e, t, n) {
        "use strict";
        return e = n.converter._dispatch("codeBlocks.before", e, t, n),
        e = (e = (e += "¨0").replace(/(?:\n\n|^)((?:(?:[ ]{4}|\t).*\n+)+)(\n*[ ]{0,3}[^ \t\n]|(?=¨0))/g, (function(e, i, o) {
            var a = i
              , s = o
              , u = "\n";
            return a = r.subParser("outdent")(a, t, n),
            a = r.subParser("encodeCode")(a, t, n),
            a = (a = (a = r.subParser("detab")(a, t, n)).replace(/^\n+/g, "")).replace(/\n+$/g, ""),
            t.omitExtraWLInCodeBlocks && (u = ""),
            a = "<pre><code>" + a + u + "</code></pre>",
            r.subParser("hashBlock")(a, t, n) + s
        }
        ))).replace(/¨0/, ""),
    ...
    r.subParser("codeSpans", (function(e, t, n) {
        ...
        e = e.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, (function(e, i, o, a) {
            var s = a;
            return s = (s = s.replace(/^([ \t]*)/g, "")).replace(/[ \t]*$/g, ""),
            s = i + "<code>" + (s = r.subParser("encodeCode")(s, t, n)) + "</code>",
    ...
    r.subParser("completeHTMLDocument", (function(e, t, n) {
        ...
        "html" !== (r = n.metadata.parsed.doctype.toString().toLowerCase()) && "html5" !== r || (a = '<meta charset="utf-8">')),
        n.metadata.parsed)
    ...
    r.subParser("encodeBackslashEscapes", (function(e, t, n) {
        "use strict";
        return e = (e = (e = n.converter._dispatch("encodeBackslashEscapes.before", e, t, n)).replace(/\\(\\)/g, r.helper.escapeCharactersCallback)).replace(/\\([`*_{}\[\]()>#+.!~=|-])/g, r.helper.escapeCharactersCallback),
        n.converter._dispatch("encodeBackslashEscapes.after", e, t, n)
    }
    )),
    r.subParser("encodeCode", (function(e, t, n) {
        "use strict";
        return e = (e = n.converter._dispatch("encodeCode.before", e, t, n)).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/([*_{}\[\]\\=~-])/g, r.helper.escapeCharactersCallback),
    ...
    r.subParser("githubCodeBlocks", (function(e, t, n) {
        ...
        e = (e = (e += "¨0").replace(/(?:^|\n)(?: {0,3})(```+|~~~+)(?: *)([^\s`~]*)\n([\s\S]*?)\n(?: {0,3})\1/g, (function(e, i, o, a) {
            ...
            return a = r.subParser("encodeCode")(a, t, n),
            a = "<pre><code" + (o ? ' class="' + o + " language-" + o + '"' : "") + ">" + (a = (a = (a = r.subParser("detab")(a, t, n)).replace(/^\n+/g, "")).replace(/\n+$/g, "")) + s + "</code></pre>",
    ...
    r.subParser("hashCodeTags", (function(e, t, n) {
        "use strict";
        return e = n.converter._dispatch("hashCodeTags.before", e, t, n),
        e = r.helper.replaceRecursiveRegExp(e, (function(e, i, o, a) {
    ...
    r.subParser("hashHTMLBlocks", (function(e, t, n) {
        ...
        for (var a = 0; a < i.length; ++a)
            for (var s, u = new RegExp("^ {0,3}(<" + i[a] + "\\b[^>]*>)","im"), c = "<" + i[a] + "\\b[^>]*>", l = "</" + i[a] + ">"; -1 !== (s = r.helper.regexIndexOf(e, u)); ) {
                var d = r.helper.splitAtIndex(e, s)
                  , h = r.helper.replaceRecursiveRegExp(d[1], o, c, l, "im");
                if (h === d[1])
                    break;
                e = d[0].concat(h)
            }
        return e = e.replace(/(\n {0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g, r.subParser("hashElement")(e, t, n)),
        e = (e = r.helper.replaceRecursiveRegExp(e, (function(e) {
            return "\n\n¨K" + (n.gHtmlBlocks.push(e) - 1) + "K\n\n"
        }
    ...
    r.subParser("unhashHTMLSpans", (function(e, t, n) {
        ...
        for (var r = 0; r < n.gHtmlSpans.length; ++r) {
            for (var i = n.gHtmlSpans[r], o = 0; /¨C(\d+)C/.test(i); ) {
                var a = RegExp.$1;
                if (i = i.replace("¨C" + a + "C", n.gHtmlSpans[a]),
                10 === o) {
    ...
    r.subParser("hashPreCodeTags", (function(e, t, n) {
        "use strict";
        return e = n.converter._dispatch("hashPreCodeTags.before", e, t, n),
        e = r.helper.replaceRecursiveRegExp(e, (function(e, i, o, a) {
            var s = o + r.subParser("encodeCode")(i, t, n) + a;
            return "\n\n¨G" + (n.ghCodeBlocks.push({
                text: e,
    ...
    r.subParser("headers", (function(e, t, n) {
        ...
        function i(e) {
            ...
            return i = e,
            o = r.helper.isString(t.prefixHeaderId) ? t.prefixHeaderId : !0 === t.prefixHeaderId ? "section-" : "",
            t.rawPrefixHeaderId || (i = o + i),
            i = t.ghCompatibleHeaderId ? i.replace(/ /g, "-").replace(/&amp;/g, "").replace(/¨T/g, "").replace(/¨D/g, "").replace(/[&+$,\/:;=?@"#{}|^¨~\[\]`\\*)(%.!'<>]/g, "").toLowerCase() : t.rawHeaderId ? i.replace(/ /g, "-").replace(/&amp;/g, "&").replace(/¨T/g, "¨").replace(/¨D/g, "$").replace(/["']/g, "-").toLowerCase() : i.replace(/[^\w]/g, "").toLowerCase(),
            t.rawPrefixHeaderId && (i = o + i),
        ...
        return e = e.replace(u, (function(e, a, s) {
            ...
            var c = r.subParser("spanGamut")(u, t, n)
              ...
              , d = o - 1 + a.length
              , h = "<h" + d + l + ">" + c + "</h" + d + ">";
            return r.subParser("hashBlock")(h, t, n)
        }
        )),
    ...
    r.subParser("images", (function(e, t, n) {
        ...
        function i(e, t, i, o, a, s, u, c) {
            ...
            e.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1)
                ...
                o = "#" + i,
                r.helper.isUndefined(l[i]))
                    return e;
                o = l[i],
                r.helper.isUndefined(d[i]) || (c = d[i]),
                r.helper.isUndefined(h[i]) || (a = h[i].width,
                s = h[i].height)
            }
            ...
            return c && r.helper.isString(c) && (p += ' title="' + (c = c.replace(/"/g, "&quot;").replace(r.helper.regexes.asteriskDashAndColon, r.helper.escapeCharactersCallback)) + '"'),
            a && s && (p += ' width="' + (a = "*" === a ? "auto" : a) + '"',
            p += ' height="' + (s = "*" === s ? "auto" : s) + '"'),
            p + " />"
        }
    ...
    r.subParser("lists", (function(e, t, n) {
        ...
        function i(e, i) {
            ...
            e = (e = e.replace(o, (function(e, i, o, s, u, c, l) {
                l = l && "" !== l.trim();
                var d = r.subParser("outdent")(u, t, n)
                  , h = "";
                return c && t.tasklists && (h = ' class="task-list-item" style="list-style-type: none;"',
                ...
                i || d.search(/\n{2,}/) > -1 ? (d = r.subParser("githubCodeBlocks")(d, t, n),
                d = r.subParser("blockGamut")(d, t, n)) : (d = (d = r.subParser("lists")(d, t, n)).replace(/\n$/, ""),
                d = (d = r.subParser("hashHTMLBlocks")(d, t, n)).replace(/\n\n+/g, "\n\n"),
                d = a ? r.subParser("paragraphs")(d, t, n) : r.subParser("spanGamut")(d, t, n)),
                "<li" + h + ">" + (d = d.replace("¨A", "")) + "</li>\n"
            }
            ))).replace(/¨0/g, ""),
            n.gListLevel--,
            i && (e = e.replace(/\s+$/, "")),
    ...
    r.subParser("metadata", (function(e, t, n) {
        ...
        e = n.converter._dispatch("metadata.after", e, t, n)) : e
    }
    )),
    ...
    r.subParser("paragraphs", (function(e, t, n) {
        ...
        for (var i = (e = (e = (e = n.converter._dispatch("paragraphs.before", e, t, n)).replace(/^\n+/g, "")).replace(/\n+$/g, "")).split(/\n{2,}/g), o = [], a = i.length, s = 0; s < a; s++) {
            var u = i[s];
            u.search(/¨(K|G)(\d+)\1/g) >= 0 ? o.push(u) : u.search(/\S/) >= 0 && (u = (u = r.subParser("spanGamut")(u, t, n)).replace(/^([ \t]*)/g, "<p>"),
            u += "</p>",
            o.push(u))
        }
        for (a = o.length,
        s = 0; s < a; s++) {
            for (var c = "", l = o[s], d = !1; /¨(K|G)(\d+)\1/.test(l); ) {
                var h = RegExp.$1
                  , p = RegExp.$2;
                c = (c = "K" === h ? n.gHtmlBlocks[p] : d ? r.subParser("encodeCode")(n.ghCodeBlocks[p].text, t, n) : n.ghCodeBlocks[p].codeblock).replace(/\$/g, "$$$$"),
                l = l.replace(/(\n\n)?¨(K|G)\d+\2(\n\n)?/, c),
    ...
    r.subParser("strikethrough", (function(e, t, n) {
        ...
        return t.strikethrough && (e = (e = n.converter._dispatch("strikethrough.before", e, t, n)).replace(/(?:~){2}([\s\S]+?)(?:~){2}/g, (function(e, i) {
            return function(e) {
                return t.simplifiedAutoLink && (e = r.subParser("simplifiedAutoLinks")(e, t, n)),
                "<del>" + e + "</del>"
            }(i)
        }
        )),
    ...
    r.subParser("stripLinkDefinitions", (function(e, t, n) {
        ...
        var i = function(e, i, o, a, s, u, c) {
            ...
            o.match(/^data:.+?\/.+?;base64,/) ? n.gUrls[i] = o.replace(/\s/g, "") : n.gUrls[i] = r.subParser("encodeAmpsAndAngles")(o, t, n),
            u ? u + c : (c && (n.gTitles[i] = c.replace(/"|'/g, "&quot;")),
            t.parseImgDimensions && a && s && (n.gDimensions[i] = {
                width: a,
                height: s
            }),
            "")
    ...
    r.subParser("tables", (function(e, t, n) {
        ...
        function o(e, i) {
            var o = "";
            return e = e.trim(),
            (t.tablesHeaderId || t.tableHeaderId) && (o = ' id="' + e.replace(/ /g, "_").toLowerCase() + '"'),
            "<th" + o + i + ">" + (e = r.subParser("spanGamut")(e, t, n)) + "</th>\n"
        }
        function a(e, i) {
        ...
        function s(e) {
            ...
            u.shift(),
            s = 0; s < u.length; ++s)
                "" !== u[s].trim() && d.push(u[s].split("|").map((function(e) {
                    return e.trim()
                }
                )));
            ...
            for (s = 0; s < c.length; ++s)
                r.helper.isUndefined(p[s]) && (p[s] = ""),
                h.push(o(c[s], p[s]));
            for (s = 0; s < d.length; ++s) {
                for (var g = [], m = 0; m < h.length; ++m)
                    r.helper.isUndefined(d[s][m]),
                    g.push(a(d[s][m], p[m]));
                f.push(g)
            }
            return function(e, t) {
        ...
        n.converter._dispatch("tables.after", e, t, n)) : e
    }
    )),
    ...
    r.subParser("makeMarkdown.emphasis", (function(e, t) {
        ...
        if (e.hasChildNodes()) {
            n += "*";
            for (var i = e.childNodes, o = i.length, a = 0; a < o; ++a)
                n += r.subParser("makeMarkdown.node")(i[a], t);
            n += "*"
        }
        return n
    }
    ...
    r.subParser("makeMarkdown.header", (function(e, t, n) {
        ...
        if (e.hasChildNodes()) {
            ...
            for (var a = e.childNodes, s = a.length, u = 0; u < s; ++u)
                o += r.subParser("makeMarkdown.node")(a[u], t)
        }
        return o
    }
    )),
    ...
    r.subParser("makeMarkdown.list", (function(e, t, n) {
        ...
        if (!e.hasChildNodes())
            return "";
        for (var o = e.childNodes, a = o.length, s = e.getAttribute("start") || 1, u = 0; u < a; ++u)
            void 0 !== o[u].tagName && "li" === o[u].tagName.toLowerCase() && (i += ("ol" === n ? s.toString() + ". " : "- ") + r.subParser("makeMarkdown.listItem")(o[u], t),
            ++s);
        return (i += "\n\x3c!-- --\x3e\n").trim()
    }
    )),
    r.subParser("makeMarkdown.listItem", (function(e, t) {
        "use strict";
        for (var n = "", i = e.childNodes, o = i.length, a = 0; a < o; ++a)
            n += r.subParser("makeMarkdown.node")(i[a], t);
    ...
    r.subParser("makeMarkdown.node", (function(e, t, n) {
        ...
        var i = "";
        if (3 === e.nodeType)
            return r.subParser("makeMarkdown.txt")(e, t);
        if (8 === e.nodeType)
    ...
    r.subParser("makeMarkdown.table", (function(e, t) {
        ...
        for (n = 0; n < u.length; ++n) {
            var d = a.push([]) - 1
              , h = u[n].getElementsByTagName("td");
            for (i = 0; i < s.length; ++i) {
                var p = " ";
                void 0 !== h[i] && (p = r.subParser("makeMarkdown.tableCell")(h[i], t)),
                a[d].push(p)
            }
        }
        var f = 3;
        ...
        for (n = 0; n < a.length; ++n) {
            for (i = 0; i < a[n].length; ++i)
                1 === n ? ":" === a[n][i].slice(-1) ? a[n][i] = r.helper.padEnd(a[n][i].slice(-1), f - 1, "-") + ":" : a[n][i] = r.helper.padEnd(a[n][i], f, "-") : a[n][i] = r.helper.padEnd(a[n][i], f);
            o += "| " + a[n].join(" | ") + " |\n"
        }
        return o.trim()
    }
    ...
    r.subParser("makeMarkdown.tableCell", (function(e, t) {
        ...
        if (!e.hasChildNodes())
            return "";
        for (var i = e.childNodes, o = i.length, a = 0; a < o; ++a)
            n += r.subParser("makeMarkdown.node")(i[a], t, !0);
        return n.trim()
    }
    )),
    r.subParser("makeMarkdown.txt", (function(e) {
        ...
        (t = (t = (t = (t = (t = (t = (t = (t = r.helper.unescapeHTMLEntities(t)).replace(/([*_~|`])/g, "\\$1")).replace(/^(\s*)>/g, "\\$1>")).replace(/^#/gm, "\\#")).replace(/^(\s*)([-=]{3,})(\s*)$/, "$1\\$2$3")).replace(/^( {0,3}\d+)\./gm, "$1\\.")).replace(/^( {0,3})([+-])/gm, "$1\\$2")).replace(/]([\s]*)\(/g, "\\]$1\\(")).replace(/^ {0,3}\[([\S \t]*?)]:/gm, "\\[$1]:")
    }
    )),
...
function(e) {
    ...
    function s(e, n) {
        ...
        e[n >> 5] |= 128 << n % 32,
        e[14 + (n + 64 >>> 9 << 4)] = n;
        for (var d = 1732584193, h = -271733879, p = -1732584194, f = 271733878, g = 0; g < e.length; g += 16)
            d = r(s = d, u = h, c = p, l = f, e[g], 7, -680876936),
            f = r(f, d, h, p, e[g + 1], 12, -389564586),
            p = r(p, f, d, h, e[g + 2], 17, 606105819),
            h = r(h, p, f, d, e[g + 3], 22, -1044525330),
            d = r(d, h, p, f, e[g + 4], 7, -176418897),
            f = r(f, d, h, p, e[g + 5], 12, 1200080426),
            p = r(p, f, d, h, e[g + 6], 17, -1473231341),
            h = r(h, p, f, d, e[g + 7], 22, -45705983),
            d = r(d, h, p, f, e[g + 8], 7, 1770035416),
            f = r(f, d, h, p, e[g + 9], 12, -1958414417),
            p = r(p, f, d, h, e[g + 10], 17, -42063),
            h = r(h, p, f, d, e[g + 11], 22, -1990404162),
            d = r(d, h, p, f, e[g + 12], 7, 1804603682),
            f = r(f, d, h, p, e[g + 13], 12, -40341101),
            p = r(p, f, d, h, e[g + 14], 17, -1502002290),
            d = i(d, h = r(h, p, f, d, e[g + 15], 22, 1236535329), p, f, e[g + 1], 5, -165796510),
            f = i(f, d, h, p, e[g + 6], 9, -1069501632),
            p = i(p, f, d, h, e[g + 11], 14, 643717713),
            h = i(h, p, f, d, e[g], 20, -373897302),
            d = i(d, h, p, f, e[g + 5], 5, -701558691),
            f = i(f, d, h, p, e[g + 10], 9, 38016083),
            p = i(p, f, d, h, e[g + 15], 14, -660478335),
            h = i(h, p, f, d, e[g + 4], 20, -405537848),
            d = i(d, h, p, f, e[g + 9], 5, 568446438),
            f = i(f, d, h, p, e[g + 14], 9, -1019803690),
            p = i(p, f, d, h, e[g + 3], 14, -187363961),
            h = i(h, p, f, d, e[g + 8], 20, 1163531501),
            d = i(d, h, p, f, e[g + 13], 5, -1444681467),
            f = i(f, d, h, p, e[g + 2], 9, -51403784),
            p = i(p, f, d, h, e[g + 7], 14, 1735328473),
            d = o(d, h = i(h, p, f, d, e[g + 12], 20, -1926607734), p, f, e[g + 5], 4, -378558),
            f = o(f, d, h, p, e[g + 8], 11, -2022574463),
            p = o(p, f, d, h, e[g + 11], 16, 1839030562),
            h = o(h, p, f, d, e[g + 14], 23, -35309556),
            d = o(d, h, p, f, e[g + 1], 4, -1530992060),
            f = o(f, d, h, p, e[g + 4], 11, 1272893353),
            p = o(p, f, d, h, e[g + 7], 16, -155497632),
            h = o(h, p, f, d, e[g + 10], 23, -1094730640),
            d = o(d, h, p, f, e[g + 13], 4, 681279174),
            f = o(f, d, h, p, e[g], 11, -358537222),
            p = o(p, f, d, h, e[g + 3], 16, -722521979),
            h = o(h, p, f, d, e[g + 6], 23, 76029189),
            d = o(d, h, p, f, e[g + 9], 4, -640364487),
            f = o(f, d, h, p, e[g + 12], 11, -421815835),
            p = o(p, f, d, h, e[g + 15], 16, 530742520),
            d = a(d, h = o(h, p, f, d, e[g + 2], 23, -995338651), p, f, e[g], 6, -198630844),
            f = a(f, d, h, p, e[g + 7], 10, 1126891415),
            p = a(p, f, d, h, e[g + 14], 15, -1416354905),
            h = a(h, p, f, d, e[g + 5], 21, -57434055),
            d = a(d, h, p, f, e[g + 12], 6, 1700485571),
            f = a(f, d, h, p, e[g + 3], 10, -1894986606),
            p = a(p, f, d, h, e[g + 10], 15, -1051523),
            h = a(h, p, f, d, e[g + 1], 21, -2054922799),
            d = a(d, h, p, f, e[g + 8], 6, 1873313359),
            f = a(f, d, h, p, e[g + 15], 10, -30611744),
            p = a(p, f, d, h, e[g + 6], 15, -1560198380),
            h = a(h, p, f, d, e[g + 13], 21, 1309151649),
            d = a(d, h, p, f, e[g + 4], 6, -145523070),
            f = a(f, d, h, p, e[g + 11], 10, -1120210379),
            p = a(p, f, d, h, e[g + 2], 15, 718787259),
            h = a(h, p, f, d, e[g + 9], 21, -343485551),
            d = t(d, s),
            h = t(h, u),
            p = t(p, c),
            f = t(f, l);
    ...
    function f(e, t, n) {
        return t ? n ? p(t, e) : l(p(t, e)) : n ? h(e) : l(h(e))
    }
    "function" == typeof define && define.amd ? define((function() {
        return f
    }
...
for (let e in atEmojiQQ)
    atEmojiQ = atEmojiQ + "<img alt='[" + e + "]' title='" + e + "' onclick='insertEmoji(\"[" + e + "]\")' class='atemoji gallery-group-img' src='" + atEmojiQQ[e] + "'/>";
for (let e in atEmojiTB)
    atEmojiT = atEmojiT + "<img alt='[" + e + "]' title='" + e + "' onclick='insertEmoji(\"[" + e + "]\")' class='atemoji gallery-group-img' src='" + atEmojiTB[e] + "'/>";
for (let e in atEmojiBB)
    atEmojiB = atEmojiB + "<img alt='[" + e + "]' title='" + e + "' onclick='insertEmoji(\"[" + e + "]\")' class='atemoji gallery-group-img' src='" + atEmojiBB[e] + "'/>";
function Logout() {
    AV.User.logOut(),
    location.reload()
}
function insertEmoji(e) {
    let t = document.getElementById("neirong")
      , n = t.value.length;
    t.focus(),
    void 0 !== document.selection ? document.selection.createRange().text = e : t.value = t.value.substr(0, t.selectionStart) + e + t.value.substring(t.selectionStart, n),
    preview()
}
function preview() {
...
atEvery.prototype._init = function() {
    let e = this
      , {appId: t, appKey: n, lang: r, pageSize: i, atEmoji: o, bgImg: a, motion: s, cssUrl: u, shuoPla: c, avatarPla: l, serverURL: d, color1: h, color2: p, color3: f} = e.config;
    switch (r = void 0 === r || "" === r ? "zh" : r,
    a = void 0 === a || "" === a ? "https://cdn.jsdelivr.net/gh/drew233/cdn/20200409110727.webp" : a,
    r) {
    case "zh":
        var g = "加载更多"
          , m = "预览"
          ...
          , I = "密码不能为空"
          , M = "用户名与密码不匹配"
          , q = "登陆失败，常见错误有<br><li>网络错误</li><li>域名不在 LeanCloud 的域名白名单中被限制登录</li><li>当前页面使用了其他leancloud应用导致登录到了其他应用所以失败</li>"
          , N = "未找到此用户"
          , L = "尝试错误密码次数过多，请稍后再试";
        break;
    case "en":
        ...
        A = "Cancel",
        x = "Post talk",
        E = "Please log in first",
        S = "Avatar url",
        O = "Are you sure you want to devare this article?",
        C = "Successfully devared",
        T = "emoji",
        P = "Loading",
        z = "Username can not be empty",
        I = "Password can not be empty",
        M = "The username and password mismatch.",
        q = "Request has been terminated Possible causes: the network is offline, Origin is not allowed by Access-Control-Allow-Origin, the page is being unloaded, etc.c",
        N = "Could not find user.",
        L = "You have entered incorrect passwords for too many times. Please try later or reset your password.";
        break;
    case "es":
        g = "Carga más",
        m = "Avance",
        ...
        A = "Cancelar",
        x = "Publicar charla",
        E = "Por favor ingresa primero",
        S = "URL del avatar",
        O = "¿Estás seguro de que deseas eliminar este artículo?",
        C = "Eliminado con éxito",
        T = "expresión",
        P = "Cargando",
        z = "El nombre de usuario no puede estar vacío",
        I = "la contraseña no puede estar en blanco",
        M = "El nombre de usuario y la contraseña no coinciden.",
        q = "La solicitud ha sido cancelada Posibles causas: la red está fuera de línea, Access-Control-Allow-Origin no permite Origin, la página se está descargando, etc.c",
        N = "No se pudo encontrar el usuario.",
        L = "Ha introducido contraseñas incorrectas demasiadas veces. Inténtelo más tarde o restablezca su contraseña."
    }
    let U = "";
    for (let e in o)
        U = U + "<img alt='[" + e + "]' title='" + e + "' onclick='insertEmoji(\"[" + e + "]\")' class='atemoji gallery-group-img' src='" + o[e] + "'/>";
    c = void 0 === c ? "" : c,
    l = void 0 === l ? "" : l,
    h = void 0 === h || "" === h ? "RGBA(255, 125, 73, 0.75)" : h,
    ...
    try {
        ...
        let t = e.toString();
        console.error(t),
        -1 != t.indexOf("appId is not defined") ? console.log("appId没找到") : -1 != t.indexOf("appKey is not defined") && console.log("appKey没找到")
    }
    function B(e) {
        if (void 0 !== e) {
    ...
    X.onclick = function() {
        ...
        R("shade"),
        e ? (R("userinfo"),
        document.getElementById("status").innerHTML = v + ":\t" + e.attributes.username,
        R("tui")) : (R("tui"),
        R("shuoshuo-modal"),
        F())
    }
    ...
    Y.onclick = function() {
        ...
        if (document.getElementById("logw").style.color = "black",
        document.getElementById("logw").innerHTML = "loading...",
        "" === t)
            return document.getElementById("logw").style.color = "red",
            void (document.getElementById("logw").innerHTML = I);
        let n = document.getElementById("username").value;
        if ("" === n)
            return document.getElementById("logw").style.color = "red",
            void (document.getElementById("logw").innerHTML = z);
        AV.User.logIn(n, t).then((t=>{
            ...
            -1 != t.indexOf("mismatch") ? t = M : -1 != t.indexOf("terminated") ? t = q : -1 != t.indexOf("Could not find user.") ? t = N : -1 != t.indexOf("Please try later or reset your password.") && (t = L),
    ...
    te.onclick = function() {
        ...
        "none" === document.getElementById("shuoshuo_emojiswitch").style.display ? (R("shuoshuo_emoji_Tieba"),
        ...
        document.getElementById("shuoshuo_emoji_custom").innerHTML = U,
        document.getElementById("shuoshuo_emojiswitch").classList.add("pingjun")) : (D("shuoshuo_emoji_Tieba"),
        D("shuoshuo_emoji_BiliBili"),
        D("shuoshuo_emoji_custom"),
        D("shuoshuo_emoji_QQ"),
    ...
    ne.onclick = function() {
        ...
        oe.classList.remove("zuiliangdezai"),
    ...
    ,
    oe.onclick = function() {
        oe.classList.add("zuiliangdezai"),
        ie.classList.remove("zuiliangdezai"),
        re.classList.remove("zuiliangdezai"),
        ne.classList.remove("zuiliangdezai"),
    ...
    ae.onclick = function() {
        ...
        -1 !== e.className.indexOf("preview_now") ? e.classList.remove("preview_now") : e.classList.add("preview_now")
    }
    ,
    ue.onclick = function() {
    ...
    atEvery.prototype.delete = function(e) {
        ...
        n("shade"),
        n("shanchur"),
        document.getElementById("delete1").innerHTML = '<input type="button" class="at_button" value="' + b + '" id="Delete"><input type="button" class="at_button" value="' + A + '" id="cancelDelete">';
...
atEvery.prototype.seeContent = function(e, t) {
    let n = ""
      , {lang: r, pageSize: i, motion: o, atEmoji: a, color1: s, color2: u, color3: c, atComment: l} = this.config;
    switch (r = void 0 === r || "" === r ? "zh" : r,
    r) {
    case "zh":
    ...
    case "en":
        ...
        h = "Please modify it in the input box below and click save",
        p = "save",
        f = "comments",
        g = "Mailbox",
        m = "Nickname";
    ...
    case "es":
        ...
        h = "Por favor, introduzca las modificaciones en el cuadro de abajo y haga clic en guardar",
        p = "guardar",
        f = "comentarios",
        g = "Buzón",
        m = "Apodo"
    ...
    let v = new AV.Query("shuoshuo")
      , b = 0;
    v.descending("createdAt"),
    v.limit(i),
    v.skip(i * e),
    v.find().then((function(t) {
        n = "",
        t.forEach((function(e) {
            ...
            let d = s.getFullYear() + "-" + u(s.getMonth() + 1) + "-" + u(s.getDate())
              , h = u(s.getHours()) + ":" + u(s.getMinutes()) + ":" + u(s.getSeconds())
              , p = s.getHours()
              , f = "";
            switch (f) {
            case p >= 0 && p < 5:
        ...
        0 !== b ? _("readmore") : 0 !== e && (document.getElementById("readButton").innerHTML = "<center>已经到底了哦~</center>",
    ...
    atEvery.prototype.atEdit = function(e) {
        ...
        n.find().then((n=>{
            n.forEach((function(n) {
                ...
                document.getElementById("atEditsaveButton").innerHTML = p,
                t("readmore"),
                i.setAttribute("onclick", 'atEvery.prototype.atEditsave("' + e + '")'),
                pubShuo.click(),
                document.getElementById("neirong").value = n.attributes.atContentMd,
                t("lazy")
            }
            ))
        }
    ...
    atEvery.prototype.saveComment = function(e, t) {
        ...
        let s = o.makeHtml(r)
          ...
          , h = md5(l);
        if (!u && ("" === d || "" === l))
            return document.getElementById("neirong").value = "昵称，邮箱均为必填项\n" + document.getElementById("neirong").value,
            void n("lazy");
        let p = "https://cdn.staticdn.net/avatar/" + h + "?d=mp&s=80"
          , f = new Date;
        function g(e) {
            return e < 10 ? "0" + e : e
        }
        ...
        i.save().then((function(e) {
            let t = '<span style="float: right"><svg t="1599635243920" cursor="pointer" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2431" width="16" height="16" fill="' + c + '"><path d="M853.3 893.6c-17.5 0-34.6-6.8-47.5-19.8l-44.4-44.4c-77.9-78.3-133-133.6-221.7-147.3v119.6c0 27.3-16.3 51.6-41.5 62.1s-53.9 4.7-73.2-14.6l-302-302c-26.2-26.2-26.2-68.8 0-95l302.1-302.1c19.3-19.3 48-25 73.2-14.6 25.2 10.4 41.5 34.8 41.5 62.1v145.5c140.6 4.1 249.5 73.7 315.4 202.1 48.2 93.9 65.4 206.8 65.4 281.2 0 27.3-16.3 51.7-41.5 62.1-8.3 3.4-17.1 5.1-25.8 5.1zM450.2 589.3H495c153.9 0 235.5 82 330 177l2.5 2.5c-5.4-48.3-18.7-118-52-182.6-52.3-101.9-136.1-153.6-248.8-153.6h-76.5V251.7l-248 248 248 248V589.3z" p-id="2432" fill="' + c + '"></path></svg></span>'
              ...
              , i = '<li style="margin: 0 0 0 48px"><span class="shuoshuo_author_img"><img src="' + p + '"class="artitalk_avatar gallery-group-img" width="48" height="48"></span><span class="cbp_tmlabel"  >  <div>' + s + '</div><p class="shuoshuo_time"><span>' + d + "</span><span>&nbsp&nbsp" + b + m + " " + _ + t + "</span></p></span></li>"
              , o = r.indexOf("</li>") + 5
    ...
    atEvery.prototype.commentInit = function(e, t) {
        ...
        let i = "atCoInit" + e;
        r("coValue" + e),
        document.getElementById(i).setAttribute("onclick", "location.reload()"),
        n("commentNick"),
        r("atSave"),
        n("commentSave"),
        n("lazy"),
        ...
        r("pubShuo"),
        r("switchUser"),
        document.getElementById("pubComment").title = f,
        ...
        document.getElementById("commentNick").placeholder = m;
        ...
        l.find().then((e=>{
            e.forEach((function(e) {
                ...
                let l = e.attributes.commentContent
                  , d = e.attributes.nick
                  , h = e.attributes.email
                  , p = e.attributes.adminAvatar
                  , f = "https://cdn.staticdn.net/avatar/" + h + "?d=mp&s=80";
                void 0 !== p && (f = p),
...
;
//# sourceMappingURL=/sm/f608484887259b63bbe9f25d1e8332cd1cfbefa72e4d346060067faac5f94eb9.map
